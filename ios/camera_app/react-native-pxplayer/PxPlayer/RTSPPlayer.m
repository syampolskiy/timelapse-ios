...
bool g_isLibAvRegistered = false;
...
@synthesize outputWidth, outputHeight, outputFPS;
...
- (id)initWithVideo:(NSString *)moviePath usesTcp:(BOOL)usesTcp
{
    ...
    if (g_isLibAvRegistered == false) {
        g_isLibAvRegistered = true;
    ...
    //
    // reduce time for \avformat_find_stream_info
    //
    pFormatCtx->max_analyze_duration = 10;
...
*/
    ...
    outputFPS = av_q2d(pFormatCtx->streams[videoStream]->r_frame_rate);
        /*
        ...
        */
    if (outputFPS < 1.0f)
        outputFPS = 1.0 / av_q2d(pFormatCtx->streams[videoStream]->codec->time_base);
