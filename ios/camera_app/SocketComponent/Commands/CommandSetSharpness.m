#import "CommandSetSharpness.h"


@interface CommandSetSharpness ()
...
@implementation CommandSetSharpness
...
- (void)execute
{
    @synchronized (self.app_state) {
        ...
        data[0] = bSharpness;
        data[1] = 255 * ((float)_sharpness / 100.0f);
        cmp_pack packet;
        ...
        if ([self.socketConnection sendPacket:&packet] == 0)
        {
            ...
            //
            self.app_state.bSharpness = _sharpness; // 0..100
        }
